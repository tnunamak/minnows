...
- H3 Max is a video-generation model (priced per second), not the MiniMax text/coding flagship; use M3 for frontier coding/agent comparison. No separate version bump in this lane.
