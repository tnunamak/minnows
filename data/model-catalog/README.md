...
<picture>
  ...
  <img src="charts/effort-curves-light.svg" alt="Effort curves for each quota pool and task family. Each line is a model and each dot an effort level; x is API cost per task on a log scale and y is the benchmark score. Filled dots are worth trying; hollow dots have a cheaper setting that scores as well.">
</picture>
...
<picture>
  ...
  <img src="charts/option-map-light.svg" alt="A table for each quota pool. Rows are models, one per capability tier, least capable first; columns are task families. Each cell has a bar with one segment per effort level, marked worth trying, mixed evidence, not compared, ruled out or not measured, and a short label naming the effort levels worth trying or the cheaper tier that does as well. The tables below give the reason for each segment.">
</picture>
...
| Coding | Claude Sonnet 5 | ○ | ○ | ○ | ← high (1 of 1) | ✕ Claude Opus 5.5 max (1 of 1) |
| Coding | Claude Opus 5.5 | ● | ● | ◐ medium (1 of 4) | ← high (3 of 3) | ← high (3 of 3) |
...
| Knowledge work | Claude Sonnet 5 | · | · | · | · | · |
...
| Agent workflows | Claude Sonnet 5 | ○ | ← low (1 of 1) | ← low (1 of 1) | ← low (1 of 1) | ← high (1 of 1) |
...
| Coding | DeepSWE Leaderboard (datacurve.ai) | [`performance/google-xai-board-snapshot-2026-09-23.json`](performance/google-xai-board-snapshot-2026-09-23.json) · third party board | B | Claude Sonnet 5 |
...
| Coding | Terminal-Bench 4.0 | [`performance/terminal-bench-4-vals-opus-5-5-2026-09.json`](performance/terminal-bench-4-vals-opus-5-5-2026-09.json) · other | C | Claude Fable 5.1, Claude Opus 5.5, Claude Sonnet 5 |
...
| Agent workflows | OSWorld-Verified | [`performance/anthropic-sonnet5-digitized-2026-07.json`](performance/anthropic-sonnet5-digitized-2026-07.json) · digitized chart | D | Claude Sonnet 5 |
...
| Coding | GPT-6 Sol | ✕ GPT-6 Luna medium (2 of 2) | ◐ GPT-6 Luna xhigh (1 of 2) | ◐ medium (1 of 2) | ← high (2 of 2) | ← xhigh (2 of 2) |
...
| Knowledge work | GPT-6 Sol | ✕ GPT-6 Luna medium (1 of 1) | ✕ GPT-6 Luna max (1 of 1) | ✕ GPT-6 Luna max (1 of 1) | ← medium (1 of 1) | ← xhigh (1 of 1) |
| Knowledge work | GPT-6 Astra | ✕ GPT-6 Luna max (1 of 1) | ✕ GPT-6 Sol xhigh (1 of 1) | ✕ GPT-6 Sol xhigh (1 of 1) | ✕ GPT-6 Sol xhigh (1 of 1) | ✕ GPT-6 Sol max (1 of 1) |
| Agent workflows | GPT-6 Luna | ● | ● | ● | ◐ high (1 of 2) | ● |
| Agent workflows | GPT-5.6 Terra | · | · | · | · | n/a |
| Agent workflows | GPT-6 Sol | ✕ GPT-6 Luna max (2 of 2) | ◐ GPT-6 Luna max (1 of 2) | ● | ← high (2 of 2) | ◐ xhigh (1 of 2) |
| Agent workflows | GPT-6 Astra | ✕ GPT-6 Sol xhigh (2 of 2) | ◐ GPT-6 Sol xhigh (1 of 2) | ← medium (3 of 3) | ← high (3 of 3) | ← xhigh (3 of 3) |
...
| Coding | DeepSWE v1.1 | [`performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json`](performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json) · vendor table | C | GPT-6 Astra, GPT-6 Luna, GPT-6 Sol |
...
| Coding | FrontierCode v1.1 (Main) | [`performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json`](performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json) · vendor table | C | GPT-6 Astra, GPT-6 Luna, GPT-6 Sol |
...
| Knowledge work | Agents' Last Exam | [`performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json`](performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json) · vendor table | C | GPT-6 Astra, GPT-6 Luna, GPT-6 Sol |
...
| Agent workflows | AutomationBench | [`performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json`](performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json) · vendor table | C | GPT-6 Astra, GPT-6 Luna, GPT-6 Sol |
| Agent workflows | OSWorld 2.0 (partial score) | [`performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json`](performance/openai-gpt-6-sol-luna-launch-curves-2026-09.json) · vendor table | C | GPT-6 Astra, GPT-6 Luna, GPT-6 Sol |
