# Task 20260923-154225-fix-model-catalog-coverage-snapshot-integrity-so A01 Plan

## Goal
DeepSWE full board and one-snapshot grouping
...
- [ ] Update `A01-deepswe-full-board-and-one-snapshot-grouping-result.md` or run `ds task checkpoint`.
